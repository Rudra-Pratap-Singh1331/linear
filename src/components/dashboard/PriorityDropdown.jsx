...
export const NoPriorityIcon = () => (
  <MoreHorizontal
    size={14}
    className="text-zinc-600 dark:text-zinc-500 shrink-0"
    strokeWidth={3}
  />
);
...
export default function PriorityDropdown({ currentPriority, onSelect, onClose }) {
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute top-[-8px] left-[-8px] w-[200px] rounded-lg z-100 py-1.5 flex flex-col animate-in fade-in zoom-in-95 duration-75 max-h-none overflow-hidden h-auto
